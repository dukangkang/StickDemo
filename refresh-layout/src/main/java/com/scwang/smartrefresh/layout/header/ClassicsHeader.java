...
//        final ViewGroup centerLayout = mCenterLayout;
        ...
        mDogText = thisView.findViewById(R.id.srl_classics_dot);
...
//            mLastUpdateText.setTextSize(12);
        ...
        String format = " HH:mm分发布";
        mLastUpdateFormat = new SimpleDateFormat(format, Locale.getDefault());
...
//    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        stopLoading();
        if (success) {
            mTitleText.setText(mTextFinish + mLastUpdateFormat.format(new Date()));
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            ...
            case PullDownToRefresh:
                mDogText.setVisibility(View.VISIBLE);
                mTitleText.setText(mTextPulling);
                arrowView.setVisibility(GONE); // by dkk UI 设计不显示
    ...
    private void startLoading() {
        ...
        mDogText.setText(loading);
    }

    private void stopLoading() {
        isStart = false;
        mDogText.setText("...");
        mDogText.setVisibility(View.GONE);
