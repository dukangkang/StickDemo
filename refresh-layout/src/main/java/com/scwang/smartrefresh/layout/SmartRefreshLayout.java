...
//        Log.w("dkk", "SmartRefreshLayout onTouchEvent");
...
//        Log.d("xzbIntercept", TAG + "->dispatchTouchEvent()");
...
//        }
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.d("xzbIntercept", TAG + "->dispatchTouchEvent()->ACTION_DOWN");
                /*----------------------------------------------------*/
                /*                   速度追踪初始化                    */
                /*----------------------------------------------------*/
                mCurrentVelocity = 0;
...
//                Log.d("xzbIntercept", TAG + "->dispatchTouchEvent()->ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP://向上抬起时处理速度追踪
                Log.d("xzbIntercept", TAG + "->dispatchTouchEvent()->ACTION_UP");
                mVelocityTracker.addMovement(e);
