...
public class RefreshHeader extends InternalClassics<RefreshHeader> implements com.scwang.smartrefresh.layout.api.RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    protected String mTextRefreshing;//"正在载入中...";
    ...
    protected String mTargetTips = "正在载入中...";
    protected String mFinishTips = "为您更新了10条新内容";

    protected ImageView mLoadingIcon = null;
    protected RelativeLayout mLoadingRlty = null;
...
//        mLastUpdateText.setTextColor(0xff7c7c7c);
        ...
        mLoadingIcon = thisView.findViewById(R.id.srl_classics_icon);
        mLoadingRlty = thisView.findViewById(R.id.srl_classics_center);
//        final ViewGroup centerLayout = mCenterLayout;
        final DensityUtil density = new DensityUtil();

        mTitleText = thisView.findViewById(R.id.srl_classics_title);
        mTitleText.setText(mTargetTips);
...
//            mArrowDrawable = new ProgressDrawable();
//            mArrowDrawable.setColor(0xff666666);
//            mArrowView.setImageDrawable(mArrowDrawable);
//            mArrowView.setImageResource(R.mipmap.weather_sun);
        }
...
//            mProgressView.setImageResource(R.mipmap.weather_sun);
        }
...
//        setLastUpdateTime(new Date(mShared.getLong(KEY_LAST_UPDATE_TIME, System.currentTimeMillis())));
    ...
    public void onStartAnimator(@NonNull RefreshLayout refreshLayout, int height, int maxDragHeight) {
        ...
        final View loadingView = mLoadingIcon;
        Drawable drawable = mLoadingIcon.getDrawable();
        if (drawable instanceof Animatable) {
            ((Animatable) drawable).start();
        } else {
            loadingView.animate().rotation(3600).setDuration(5000);
        }
    }
...
//            mTitleText.setCompoundDrawablesRelativeWithIntrinsicBounds(R.mipmap.chenggong, 0, 0, 0);
//            if (mLastTime != null) {
//                setLastUpdateTime(new Date());
//            }
//            if(mTitleText!=null){
...
//                    @Override
//                    public void run() {
//                        mTitleText.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, 0, 0);
//                    }
//                },500);
//            }
        } else {
        ...
        final View loadingIcon = mLoadingIcon;
        Drawable drawable = mLoadingIcon.getDrawable();
        if (drawable instanceof Animatable) {
            ...
            loadingIcon.animate().rotation(0).setDuration(0);
        }
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            ...
            case PullDownToRefresh:
                // for jk
                mTitleText.setText(mTargetTips);
                mLoadingRlty.setVisibility(View.VISIBLE);
