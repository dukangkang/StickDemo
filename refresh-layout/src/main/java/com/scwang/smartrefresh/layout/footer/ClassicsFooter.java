...
//    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        if (!mNoMoreData) {
            if (success) {
                mTitleText.setTextColor(getResources().getColor(R.color.comm_loading_finish_color));
            } else {
                mTitleText.setTextColor(getResources().getColor(R.color.comm_loading_color));
            }
